  ...
  return (
    <footer className="relative z-10 border-t border-border bg-card/30 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-4 py-10 sm:py-12">
        ...
        <div className="sm:hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground max-w-xs mx-auto">
              Born of Light, Forged in Shadow. Build the System. Ascend.
            </p>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-6 sm:pt-8 border-t border-border/50 flex flex-col items-center justify-center">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-xs text-muted-foreground/60 hover:text-primary transition-colors mt-1"
          >
