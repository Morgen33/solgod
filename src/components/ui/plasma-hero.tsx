      ...
      >
        {heroImages.map((hero, index) => (
          <img 
            ...
            style={{
              // Scale the character relative to the ball - sized to fit within the sphere
              width: `${characterScale * (isMobileViewport ? 145 : 115) * hero.scale}vh`,
              maxWidth: `${characterScale * (isMobileViewport ? 145 : 115) * hero.scale}vw`,
