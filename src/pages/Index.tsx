          ...
          <div className="space-y-16">
              ...
              <div className="grid md:grid-cols-2 gap-6 ml-14">
                <GlowCard glowColor="blue" customSize className="w-full h-auto">
                  <div className="flex flex-col">
                    <h4 className="font-semibold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #66d9ff, #01b2ff)", textShadow: "0 0 20px rgba(102, 217, 255, 0.5)" }}>Active Ecosystem Management</h4>
                ...
                <GlowCard glowColor="blue" customSize className="w-full h-auto">
                  <div className="flex flex-col">
                    <h4 className="font-semibold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #66d9ff, #01b2ff)", textShadow: "0 0 20px rgba(102, 217, 255, 0.5)" }}>Engagement-Led Rewards</h4>
                ...
                <GlowCard glowColor="blue" customSize className="w-full h-auto">
                  <div className="flex flex-col">
                    <h4 className="font-semibold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #66d9ff, #01b2ff)", textShadow: "0 0 20px rgba(102, 217, 255, 0.5)" }}>Exclusive Holder Perks</h4>
                ...
                <GlowCard glowColor="blue" customSize className="w-full h-auto">
                  <div className="flex flex-col">
                    <h4 className="font-semibold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #66d9ff, #01b2ff)", textShadow: "0 0 20px rgba(102, 217, 255, 0.5)" }}>Sustainable Scaling</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 ml-14">
                <GlowCard glowColor="blue" customSize className="w-full h-auto">
                  <div className="flex flex-col">
                    <h4 className="font-semibold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #66d9ff, #01b2ff)", textShadow: "0 0 20px rgba(102, 217, 255, 0.5)" }}>Results First</h4>
                ...
                <GlowCard glowColor="blue" customSize className="w-full h-auto">
                  <div className="flex flex-col">
                    <h4 className="font-semibold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #66d9ff, #01b2ff)", textShadow: "0 0 20px rgba(102, 217, 255, 0.5)" }}>Proven Performance</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="ml-14">
                <GlowCard glowColor="blue" customSize className="w-full h-auto">
                  <div className="flex flex-col">
                    <h4 className="font-semibold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #66d9ff, #01b2ff)", textShadow: "0 0 20px rgba(102, 217, 255, 0.5)" }}>Collaborative Growth</h4>
