      ...
      <section className="min-h-[90vh] flex items-center justify-center px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          animation: "fade-in 0.8s ease-out forwards"
            ...
            <MorphingText words={["Probably Nothing", "Probably Something", "Probably Everything"]} colors={["#a1e25b", "#32db9a", "#098fcc"]} className="text-2xl sm:text-3xl md:text-4xl font-bold mt-4" interval={2500} />
          </div>
