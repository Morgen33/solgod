  ...
  return (
    <Layout>
      ...
      <section className="min-h-[85vh] flex flex-col items-center justify-center px-4 pt-20 md:pt-0 relative">
        ...
        {/* Quick Links Card - Hidden on mobile for performance */}
        {!isMobile && (
          <div 
        ...
        <div className="max-w-4xl mx-auto">
          {isMobile ? (
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4" style={{ color: "#2d5fbd" }}>Ascend to Divinity</h2>
              <p className="text-muted-foreground mb-6 text-sm">
                Become a SolGod. Join our Discord to secure your place in the inner circle.
              </p>
              <ShinyButton as="a" href="https://discord.gg/nfts" target="_blank" rel="noopener noreferrer">
                Join Discord
              </ShinyButton>
