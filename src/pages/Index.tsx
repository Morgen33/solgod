  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 overflow-hidden">
        {/* CodePen Sparkling Boxes background */}
        <iframe
          src="https://codepen.io/soju22/embed/pvyaomb?default-tab=html,result"
          title="Sparkling Boxes Background"
          className="absolute inset-0 w-full h-full border-0 opacity-50"
          loading="lazy"
          allowTransparency
        />

        {/* Optional overlay for readability (adjust /40 to /20 or /60 as needed) */}
            ...
            {quickLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-card/80 backdrop-blur border border-border rounded-xl p-5 flex flex-col items-center text-center hover:scale-105 hover:border-primary/50 transition-all duration-300 group"
                >
