    ...
    <Layout>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <GlowCard glowColor="blue" customSize className="w-full h-auto rounded-2xl p-8 sm:p-12 mb-12">
          ...
          {/* Ready to Start CTA */}
          <GlowCard glowColor="blue" customSize className="w-full h-auto rounded-2xl p-8 sm:p-12 mb-12 text-center">
