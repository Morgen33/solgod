          ...
          <div className="bg-secondary/50 border border-border rounded-2xl p-8 sm:p-12">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-3 mt-3">
                <a href="https://x.com/AxeRedwizard" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/20 border border-cyan-400/40 rounded-full text-cyan-300 hover:bg-cyan-500/30 hover:shadow-[0_0_15px_rgba(34,211,238,0.3)] transition-all duration-300">
                  @AxeRedwizard
          ...
          <div className="bg-secondary/50 border border-border rounded-2xl p-8 sm:p-12">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-3">
                ...
                <a href="https://discord.gg/ptVygzkp" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm font-medium rounded-full bg-blue/20 border border-blue/30 hover:bg-blue/30 hover:border-blue/50 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all duration-300 inline-flex items-center gap-2">
          ...
          <div className="bg-secondary/50 border border-border rounded-2xl p-8 sm:p-12">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-3">
                ...
                <a href="https://discord.gg/Zf9hWDFdQJ" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm font-medium rounded-full bg-blue/20 border border-blue/30 hover:bg-blue/30 hover:border-blue/50 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all duration-300 inline-flex items-center gap-2">
                  Discord <ExternalLink size={12} />
                </a>
              </div>
            </div>
          ...
          <div className="bg-secondary/50 border border-border rounded-2xl p-8 sm:p-12">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-3">
                ...
                <a href="https://x.com/AuskynSolGodNFT" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/20 border border-cyan-400/40 rounded-full text-cyan-300 hover:bg-cyan-500/30 hover:shadow-[0_0_15px_rgba(34,211,238,0.3)] transition-all duration-300">
                  @Auskyn
                  <ExternalLink className="w-3.5 h-3.5" />
                </a>
                <span className="text-muted-foreground mx-2">|</span>
