          ...
          <div className="bg-secondary/50 border border-border rounded-2xl p-8 sm:p-12">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-3">
                ...
                <a href="https://discord.gg/nfts" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm font-medium rounded-full bg-blue/20 border border-blue/30 hover:bg-blue/30 hover:border-blue/50 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all duration-300 inline-flex items-center gap-2">
                  Discord <ExternalLink size={12} />
                </a>
              </div>
            </div>
